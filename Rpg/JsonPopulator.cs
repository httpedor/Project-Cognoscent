...
public class JsonPopulator
{
    ...
    protected virtual FieldInfo? GetField(ref Utf8JsonReader reader, JsonSerializerOptions options, object obj, string fieldName)
    {
        if (obj == null)
        ...
        var field = obj.GetType().GetField(fieldName, BindingFlags.IgnoreCase |  BindingFlags.Public | BindingFlags.Instance);
        return field;
    }
    ...
    protected virtual bool SetPropertyValue(ref Utf8JsonReader reader, JsonSerializerOptions options, object obj, string propertyName)
    {
        ...
        var field = GetField(ref reader, options, obj, propertyName);
        if (field != null)
        {
            if (!TryReadPropertyValue(ref reader, options, field.FieldType, out var value))
                return false;
